-- Combined Studio Migrations for Supabase
-- Run this in Supabase SQL Editor: https://supabase.com/dashboard/project/okakomwfikxmwllvliva/sql

-- =============================================================================
-- MIGRATION 007: Create studio_jobs table
-- =============================================================================

-- Create storage bucket for studio-generated assets
...
-- Done!
SELECT 'Studio migrations applied successfully!' AS status;
