// Working photo upload function built from minimal version
...
exports.handler = async (event) => {
    ...
    try {
        console.log('Working photo upload started');
        ...
        // Parse multipart form data with a simpler approach
        const formData = await parseFormData(event);

        console.log('Form parsed:', {
            fields: Object.keys(formData.fields).length,
        ...
        const elapsed = Date.now() - startTime;
        console.error('Working photo upload error:', error);
        return response(500, {
